package com.fundaciones.andrearodriguez.fundaciones.addgato.ui;
...
public class AddGatoFragment extends DialogFragment implements DialogInterface.OnShowListener, AddGatoView {
    ...
    @Bind(R.id.txtNombre)
    EditText txtNombre;
    @Bind(R.id.wrapernamegato)
    TextInputLayout wrapernamegato;
    @Bind(R.id.txtEdad)
    EditText txtEdad;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity())
                .setTitle(R.string.addcontact_messagge_title2)
        ...
        View view = getActivity().getLayoutInflater().inflate(R.layout.fragment_row_gato_get_data, null);
    ...
    private void adapterAños() {
        adapterEdad = ArrayAdapter.createFromResource(getActivity(), R.array.SelectEdad, android.R.layout.simple_spinner_item);
    ...
    private void adapterVacunacion() {
        adapterVacunado = ArrayAdapter.createFromResource(getActivity(), R.array.SelectVacuna, android.R.layout.simple_spinner_item);
    ...
    private void adapterGenero() {
        adapterSexo = ArrayAdapter.createFromResource(getActivity(), R.array.SelectSexo, android.R.layout.simple_spinner_item);
    ...
    private void adapterEstatura() {
        adapterTamano = ArrayAdapter.createFromResource(getActivity(), R.array.SelectTamanoGatos, android.R.layout.simple_spinner_item);
    ...
    private void adapterEstrilizacion() {
        ...
        adapterEsteril = ArrayAdapter.createFromResource(getActivity(), R.array.SelectEsteril, android.R.layout.simple_spinner_item);
    ...
    private void adapterDiscapacitado() {
        ...
        adapterDiscapacidad = ArrayAdapter.createFromResource(getActivity(), R.array.SelectDiscapa, android.R.layout.simple_spinner_item);
    ...
    private void setupinjection() {
        ...
        app.getAddGatoComponent(this).inject(this);
    }


    @Override
    public void onDestroy() {
        addGatoPresenter.onDestroy();
        super.onDestroy();
    }
    ...
    private void setpic() {
        int targetW = imgCat.getWidth();
        int targetH = imgCat.getHeight();
    ...
    private String getRealPathFromURI(Uri contentURI) {
        ...
        if (cursor == null) {
            ...
            if (contentURI.toString().contains("mediaKey")) {
                ...
                try {
                    File file = File.createTempFile("tempImgG", ".jpg", getActivity().getCacheDir());

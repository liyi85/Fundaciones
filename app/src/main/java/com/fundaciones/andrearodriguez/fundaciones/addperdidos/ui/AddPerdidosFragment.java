package com.fundaciones.andrearodriguez.fundaciones.addperdidos.ui;
...
public class AddPerdidosFragment extends DialogFragment implements DialogInterface.OnShowListener, AddPerdidosView {


    @Bind(R.id.imgPerdido)
    ImageButton imgPerdido;
    @Bind(R.id.txtPhone)
    EditText txtPhone;
    @Bind(R.id.wraperTelefono)
    TextInputLayout wraperTelefono;
    @Bind(R.id.txtEmail)
    EditText txtEmail;
    @Bind(R.id.wraperemail)
    TextInputLayout wraperemail;
    @Bind(R.id.txtCaracteristicas)
    EditText txtCaracteristicas;
    @Bind(R.id.wrapercaracterisitcas)
    TextInputLayout wrapercaracterisitcas;
    @Bind(R.id.txtNombre)
    EditText txtNombre;
    @Bind(R.id.wrapernameperdido)
    TextInputLayout wrapernameperdido;
    @Bind(R.id.txtEdad)
    EditText txtEdad;
    ...
    @Bind(R.id.containerAddL)
    FrameLayout containerAddL;
    ...
    @Inject
    AddPerdidosPresenter addPerdidosPresenter;

    private static final int REQUEST_PICTURE = 1;

    public AddPerdidosFragment() {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = getActivity().getLayoutInflater().inflate(R.layout.fragment_row_perdidos_get_data, null);
    ...
    private void adapterTipo() {
        adapterEspecie = ArrayAdapter.createFromResource(getContext(), R.array.SelectEspeciePerdidos, android.R.layout.simple_spinner_item);
    ...
    private void setupinjection() {
        app.getAddPerdidosComponent(this).inject(this);
    }


    @Override
    public void onActivityCreated(Bundle savedInstanceState) {
        addPerdidosPresenter.onCreate();
        super.onActivityCreated(savedInstanceState);
    }

    @Override
    public void onDestroy() {
        addPerdidosPresenter.onDestroy();
        super.onDestroy();
    }
    ...
    private void setpic() {
        int targetW = imgPerdido.getWidth();
        int targetH = imgPerdido.getHeight();
        ...
        imgPerdido.setImageBitmap(bitmap);
    }


    @OnClick(R.id.imgPerdido)
    ...
    private File getFile() {
        ...
        try {
            ...
            Snackbar.make(containerAddL, R.string.main_error_dispatch_camera, Snackbar.LENGTH_SHORT).show();
        }
        photoPath = photoFile.getAbsolutePath();
        return photoFile;
    }

    private List<Intent> addIntentsToList(List<Intent> list, Intent
            intent) {

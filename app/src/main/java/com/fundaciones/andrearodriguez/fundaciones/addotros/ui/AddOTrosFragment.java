package com.fundaciones.andrearodriguez.fundaciones.addotros.ui;
 ...
 */
public class AddOTrosFragment extends DialogFragment implements DialogInterface.OnShowListener, AddOtrosView {

    @Bind(R.id.imgOtro)
    ImageButton imgOtro;
    @Bind(R.id.txtNombre)
    EditText txtNombre;
    @Bind(R.id.wrapernameotro)
    TextInputLayout wrapernameotro;
    @Bind(R.id.txtEdad)
    EditText txtEdad;
    ...
    @Bind(R.id.containerAddO)
    FrameLayout containerAddO;

    private String photoPath;
    private FundacionesApp app;

    ArrayAdapter<CharSequence> adapterEspecie;
    ...
    @Inject
    AddOtrosPresenter addOtrosPresenter;

    private static final int REQUEST_PICTURE = 1;

    public AddOTrosFragment() {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = getActivity().getLayoutInflater().inflate(R.layout.fragment_row_otros_get_data, null);
    ...
    private void adapterTipo() {
        adapterEspecie = ArrayAdapter.createFromResource(getContext(), R.array.SelectEspecie, android.R.layout.simple_spinner_item);
    ...
    private void setupinjection() {
        app.getAddOtroComponent(this).inject(this);
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        addOtrosPresenter.onCreate();
        super.onActivityCreated(savedInstanceState);
    }

    @Override
    public void onDestroy() {
        addOtrosPresenter.onDestroy();
        super.onDestroy();
    }
            ...
            positiveButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (nombre == "" || edad == " Años" || sexo == "Hembra" || path == null) {
                        Snackbar.make(containerAddO, "Todos los datos son necesarios", Snackbar.LENGTH_LONG).show();
                    } else if (nombre != "" && edad != " Años" && sexo != "Hembra" && especie != null && esteril != null && vacuna != null && path != null) {
                        addOtrosPresenter.uploadPhoto(nombre, especie, edad, sexo, photoPath, esteril, vacuna, discapacidad);
                        Log.i("que sale", "" + nombre + " " + edad + " " + sexo + " " + especie + " " + photoPath + " " + esteril + " " + vacuna);
    ...
    private void setpic() {
        int targetW = imgOtro.getWidth();
        int targetH = imgOtro.getHeight();
        ...
        imgOtro.setImageBitmap(bitmap);
    }


    @OnClick(R.id.imgOtro)
    ...
    private File getFile() {
        ...
        try {
            ...
            Snackbar.make(containerAddO, R.string.main_error_dispatch_camera, Snackbar.LENGTH_SHORT).show();
        }
    ...
    private void showSnackbar(String msg) {
        Snackbar.make(containerAddO, msg, Snackbar.LENGTH_SHORT).show();
    }

    private void showSnackbar(int strResult) {
        Snackbar.make(containerAddO, strResult, Snackbar.LENGTH_SHORT).show();
    }
